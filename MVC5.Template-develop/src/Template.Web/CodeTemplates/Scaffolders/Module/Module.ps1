...
$DataProject = "Template.Data"
$TestsProject = "Template.Tests"
$RazorViewProject = "Template.Web"
$ObjectsProject = "Template.Objects"
$ServiceProject = "Template.Services"
$ValidatorProject = "Template.Validators"
$ControllerProject = "Template.Controllers"
